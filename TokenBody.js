    ...
    <div className="body">
      ...
      {state.insufficientTokens
        ? [
            <p style={{ color: "red" }}>
              <b>
                You do not have enough {state.tokenName} to complete this
                transaction.
              </b>
            </p>,
            <p>
              ...
              <b>
                ...
                {d(
                  util
                    ...
                    .sub(util.BN(state.tokenBalance))
                )}{" "}
                {state.tokenSymbol}{" "}
              </b>
              to your{" "}
              <a
                ...
                href={
                  ...
                  location.pathname +
                  "?chain=" +
                  app.state.chain.slug
                }
              >
                <b>HyperMask wallet</b>
              </a>{" "}
              and try again. You may be able to purchase through a token
              exchange such as{" "}
        ...
        : [
            <p>
              You have enough <b>{state.tokenName}</b> to complete this
              transaction with
              <b>
                {" "}
                {d(
                  util
                    ...
                    .sub(util.BN(state.tokenMethodParams._value))
                )}{" "}
                {state.tokenSymbol}{" "}
              </b>
              to spare.
            ...
            <p>
              You will also need <Price wei={state.priceEstimate} /> cover the
              transaction fee.
            </p>
          ]}
    </div>
